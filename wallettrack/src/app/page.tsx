        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">WalletTrack</h1>
            </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Easily log and categorize your income and expenses with detailed
              descriptions.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Create monthly budgets for different categories and monitor your
              spending limits.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">
              Get beautiful charts and analytics to understand your financial
              patterns.
            </p>
          </div>
        </div>
